...
--   '.html' files in the process. Recording unsuccessful reads and writes to
--   stderr.
--
...
data DirContents
    = DirContents
        ...
        , dcFilesToCopy :: [FilePath]
            -- ^ Other files paths, to be copied directly
        }
...
txtsToRenderedHtml txtFiles =
    let
        txtOutputFiles = map to OutputMarkupFile txtFiles
...
-- | Try to apply an IO function on a list of values,
